...
/**
 * Détruit proprement la session active
 */
...
{
	return preg_match("/[^0-9(.{1})]/", $valeur) == 0;
}
...
/* retourne le chiffrement du mot de passe en utilisant la fonction de hachage cryptographique SHA1 */
